...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        ...
        <xsl:text>Liczba albumów: </xsl:text><xsl:value-of
            select="MuzycznyRaport/Podsumowanie_informacji/Liczba_Albumów"/><xsl:text>&#xA;</xsl:text>
        <xsl:text>Laczna liczba piosenek: </xsl:text><xsl:value-of
            select="MuzycznyRaport/Podsumowanie_informacji/Łączna_liczba_piosenek"/><xsl:text>&#xA;</xsl:text>
        <xsl:text>Liczba albumów rockowych: </xsl:text><xsl:value-of
            select="MuzycznyRaport/Podsumowanie_informacji/Liczba_albumów_rockowych"/><xsl:text>&#xA;</xsl:text>
        <xsl:text>Liczba albumów rapowych: </xsl:text><xsl:value-of
            select="MuzycznyRaport/Podsumowanie_informacji/Liczba_albumów_rapowych"/><xsl:text>&#xA;</xsl:text>
        <xsl:text>Liczba albumów bluesowych: </xsl:text><xsl:value-of
            select="MuzycznyRaport/Podsumowanie_informacji/Liczba_albumów_bluesowych"/><xsl:text>&#xA;</xsl:text>
        <xsl:text>Liczba albumów funkowych: </xsl:text><xsl:value-of
            select="MuzycznyRaport/Podsumowanie_informacji/Liczba_albumów_funkowych"/><xsl:text>&#xA;</xsl:text>
        <xsl:text>Liczba albumów jazzowych: </xsl:text><xsl:value-of
            select="MuzycznyRaport/Podsumowanie_informacji/Liczba_albumów_jazzowych"/><xsl:text>&#xA;</xsl:text>
        <xsl:text>Liczba albumów metalowych: </xsl:text><xsl:value-of
            select="MuzycznyRaport/Podsumowanie_informacji/Liczba_albumów_metalowych"/><xsl:text>&#xA;</xsl:text>
        <xsl:text>Najwyższa ocena albumu: </xsl:text><xsl:value-of
            select="MuzycznyRaport/Podsumowanie_informacji/Najwyższa_ocena_albumu"/><xsl:text>&#xA;</xsl:text>
        <xsl:text>Najwyżej oceniany album: </xsl:text><xsl:value-of
            select="MuzycznyRaport/Podsumowanie_informacji/Najwyżej_oceniany_album"/><xsl:text>&#xA;</xsl:text>
        <xsl:text>Należność w PLN za zamówienie: </xsl:text><xsl:value-of
            select="MuzycznyRaport/Podsumowanie_informacji/Należność_w_POLSKICH_ZLOTYCH_za_zamówienie"/><xsl:text>&#xA;</xsl:text>
        <xsl:text>Należność w GBP za zamówienie: </xsl:text><xsl:value-of
            select="MuzycznyRaport/Podsumowanie_informacji/Należność_w_FUNTACH_za_zamówienie"/><xsl:text>&#xA;</xsl:text>
        <xsl:text>Należność w EURO za zamówienie: </xsl:text><xsl:value-of
            select="MuzycznyRaport/Podsumowanie_informacji/Należność_w_EURO_za_zamówienie"/><xsl:text>&#xA;</xsl:text>
        <xsl:text>Należność w USD za zamówienie: </xsl:text><xsl:value-of
            select="MuzycznyRaport/Podsumowanie_informacji/Należność_w_DOLARACH_za_zamówienie"/><xsl:text>&#xA;</xsl:text>
        <xsl:text>VAT odprowadzony od zamówienia: </xsl:text><xsl:value-of
            select="MuzycznyRaport/Podsumowanie_informacji/VAT_odprowadzony_od_zamówienia"/><xsl:text>&#xA;</xsl:text>
